 ...
 */
$config['site_title']                 = lang('Discover Nice');       // Site Title, example.com
$config['admin_email']                = "info@tricypolitain.com"; // Admin Email, admin@example.com
...
$config['email_config'] = [
	  'protocol' => 'smtp',
    'smtp_host' => 'ssl://mail.gandi.net',
    'smtp_port' => 465,
    'smtp_user' => 'info@tricypolitain.com',
    'smtp_pass' => 'ILOVElove12!@',
    'mailtype'  => 'html', 
    'charset'   => 'utf-8'
];
